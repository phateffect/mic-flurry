...
readonly DEFINITIONS='$(inherited) DEBUG=0 kDriver_Name=\"MicFlurry\" kDevice_Name=\"MicFlurry\" kDevice2_Name=\"MicFlurry\ Internal\" kHas_Driver_Name_Format=false kPlugIn_BundleID=\"io.phateffect.MicFlurry\" kPlugIn_Icon=\"\" kManufacturer_Name=\"MicFlurry\" kNumber_Of_Channels=1 kSampleRates=8000,16000,44100,48000 kDevice_IsHidden=false kDevice_HasInput=true kDevice_HasOutput=false kDevice2_IsHidden=true kDevice2_HasInput=false kDevice2_HasOutput=true'
